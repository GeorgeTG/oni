...
export class TutorialManager {
    ...
    private _onTutorialCompletedEvent: Event<void> = new Event<void>("TutorialManager::onTutorialCompletedEvent")
    private _onTutorialProgressChanged: Event<void> = new Event<void>("TutorialManager::onTutorialProgressChanged")
