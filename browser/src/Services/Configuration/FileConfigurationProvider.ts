...
export class FileConfigurationProvider implements IConfigurationProvider {
    ...
    private _configurationChangedEvent = new Event<void>("FileConfigurationProvider::configurationChangedEvent")
    private _configurationErrorEvent = new Event<Error>("FileConfigurationProvider::configurationErrorEvent")
