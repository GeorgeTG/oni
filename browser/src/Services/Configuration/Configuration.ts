...
export class Configuration implements Oni.Configuration {
    ...
    private _onConfigurationErrorEvent: Event<Error> = new Event<Error>("Configuration::onConfigurationErrorEvent")

    private _onConfigurationUpdatedEvent = new Event<IConfigurationUpdateEvent>("Configuration::onConfigurationUpdatedEvent")
    ...
    public registerSetting<T>(
        ...
        const newEvent = new Event<IConfigurationSettingValueChangedEvent<any>>("Configuration::newEvent")
