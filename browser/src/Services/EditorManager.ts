...
export class EditorManager implements Oni.EditorManager {
    ...
    private _onActiveEditorChanged: Event<Oni.Editor> = new Event<Oni.Editor>("EditorManager::onActiveEditorChanged")
...
class AnyEditorProxy implements Oni.Editor {
    ...
    private _onBufferChanged = new Event<Oni.EditorBufferChangedEventArgs>("EditorManager::onBufferChanged")
    private _onBufferSaved = new Event<Oni.EditorBufferEventArgs>("EditorManager::onBufferSaved")
    private _onBufferScrolled = new Event<Oni.EditorBufferScrolledEventArgs>("EditorManager::onBufferScrolled")
