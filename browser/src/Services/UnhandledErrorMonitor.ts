...
export class UnhandledErrorMonitor {
    private _onUnhandledErrorEvent = new Event<Error>("UnhandledErrorMonitor::onUnhandledErrorEvent")
    private _onUnhandledRejectionEvent = new Event<string>("UnhandledErrorMonitor::onUnhandledRejectionEvent")
