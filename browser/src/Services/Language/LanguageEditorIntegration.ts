...
export class LanguageEditorIntegration implements OniTypes.IDisposable {
    ...
    private _onHideDefinition: OniTypes.Event<void> = new OniTypes.Event<void>("LanguageEditorIntegration::onHideDefinition")

    private _onShowHover: OniTypes.Event<IHoverResult> = new OniTypes.Event<IHoverResult>("LanguageEditorIntegration::onShowHover")
    private _onHideHover: OniTypes.Event<void> = new OniTypes.Event<void>("LanguageEditorIntegration::onHideHover")
