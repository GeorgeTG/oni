...
export class YarnPluginInstaller implements IPluginInstaller {
    private _onOperationStarted = new Event<IPluginInstallerOperationEvent>("PluginInstaller::onOperationStarted")
    private _onOperationCompleted = new Event<IPluginInstallerOperationEvent>("PluginInstaller::onOperationCompleted")
    private _onOperationError = new Event<IPluginInstallerOperationEvent>("PluginInstaller::onOperationError")
