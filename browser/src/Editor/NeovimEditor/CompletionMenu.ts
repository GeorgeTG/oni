...
export class CompletionMenu {
    private _onItemFocusedEvent: Event<types.CompletionItem> = new Event<types.CompletionItem>("CompletionMenu::onItemFocusedEvent")
    private _onItemSelectedEvent: Event<types.CompletionItem> = new Event<types.CompletionItem>("CompletionMenu::onItemSelectedEvent")
