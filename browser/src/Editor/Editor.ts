...
export class Editor extends Disposable implements Oni.Editor {
    ...
    private _onBufferChangedEvent = new Event<Oni.EditorBufferChangedEventArgs>("Editor::onBufferChangedEvent")
    private _onBufferSavedEvent = new Event<Oni.EditorBufferEventArgs>("Editor::onBufferSavedEvent")
    private _onBufferScrolledEvent = new Event<Oni.EditorBufferScrolledEventArgs>("Editor::onBufferScrolledEvent")
