...
export class NeovimInstance extends EventEmitter implements INeovimInstance {
    ...
    private _onCommandLineShowEvent = new Event<INeovimCommandLineShowEvent>("NeovimInstance::onCommandLineShowEvent")
    private _onCommandLineHideEvent = new Event<void>("NeovimInstance::onCommandLineHideEvent")
    private _onCommandLineSetCursorPositionEvent = new Event<INeovimCommandLineSetCursorPosition>("NeovimInstance::onCommandLineSetCursorPositionEvent")
    ...
    private _onWildMenuSelectEvent = new Event<IWildMenuSelectEvent>("NeovimInstance::onWildMenuSelectEvent")
    private _onWildMenuShowEvent = new Event<IWildMenuShowEvent>("NeovimInstance::onWildMenuShowEvent")
